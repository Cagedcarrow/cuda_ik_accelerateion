...
//
// Ablation build flags (compile with -D flag):
//   ABLATION_NO_PADDEDMAT  — Set PADDEDMAT_STRIDE=6 (raw 6-col, measure bank conflicts)
//   ABLATION_NO_CONSTMEM   — Replace __constant__ reads with global memory parameter

#define CUDA_DEFINE_CONSTANTS

// Shared memory sizing adapts to PADDEDMAT_STRIDE (defined in cuda_utilities.cuh)
#ifndef PADDEDMAT_STRIDE
#define PADDEDMAT_STRIDE 8
#endif
