...
// ============================================================================
#ifdef ABLATION_NO_PADDEDMAT
  #define PADDEDMAT_STRIDE 6   // Raw 6-column layout for ablation study
#else
  #define PADDEDMAT_STRIDE 8   // 8-column padded layout (bank-conflict-free)
#endif
