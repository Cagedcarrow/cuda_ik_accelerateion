...
| Grid/Block | (100,1,1) × (64,1,1) |
| Duration | **10.43 μs** (100帧) |
| Registers | 36/thread (零溢出) |
| Shared Memory | 0 bytes |
| Theoretical Occupancy | 100% |
| Achieved Occupancy | 15.40% |
| 实际活跃Warp/SM | 7.39 |
| FP64利用率 | 3% of peak |
| L1命中率 | 58.86% |
| L2命中率 | 79.22% |
...
| 方案 | 耗时 | 加速比 |
|------|------|--------|
| CPU FCL (273目标) | ~0.9 s | 基线 |
| GPU OBB+GJK (100帧 ncu实测) | 10.43 μs | **~86×** |
